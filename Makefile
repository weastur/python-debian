.PHONY: all build pack clean python3.10-bullseye python3.10-buster clean-python3.10-bullseye clean-python3.10-buster
...
build: python3.10-bullseye python3.10-buster
...
clean: clean-python3.10-bullseye clean-python3.10-buster
